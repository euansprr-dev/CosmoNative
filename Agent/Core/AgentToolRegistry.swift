                    ...
                    "properties": [
                        ...
                        "operations": [
                            ...
                            "items": [
                                "type": "object",
                                "properties": [
                                    "kind": ["type": "string", "enum": ["textReplacement", "textInsertion", "structuredFieldReplacement", "formatMarks", "canvasPlan"], "description": "textReplacement: replace originalText with proposedText in place. textInsertion: insert proposedText immediately after the originalText anchor. structuredFieldReplacement: replace a structured field. formatMarks: apply formatting (formatMark) to originalText without changing the words — proposedText is not needed. Prefer textReplacement for wording changes, formatMarks for appearance changes."] as [String: Any],
