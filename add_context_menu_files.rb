...
if canvas_group
  add_file_with_absolute_path(canvas_group, 'Canvas/CanvasBlockFrameTracker.swift', target)
  add_file_with_absolute_path(canvas_group, 'Canvas/BlockContextMenu.swift', target)
else
  puts "Warning: Could not find Canvas group"
end

project.save
puts "Project saved successfully! Added context menu files."
